...
import type { GetHealthStatusError, GetHealthStatusResponse, RegisterData, RegisterError, RegisterResponse, LoginData, LoginError, LoginResponse, LogoutError, LogoutResponse, SelfError, SelfResponse, UpdateUserData, UpdateUserError, UpdateUserResponse, UpdateUserScoreData, UpdateUserScoreError, UpdateUserScoreResponse, GetUserScoreError, GetUserScoreResponse, GetQuizError, GetQuizResponse, GetVideoData, GetVideoError, GetVideoResponse } from './types.gen';
...
export const updateUserScore = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<UpdateUserScoreData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateUserScoreResponse, UpdateUserScoreError, ThrowOnError>({
        ...options,
        url: '/api/user/score'
    });
};

export const getUserScore = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetUserScoreResponse, GetUserScoreError, ThrowOnError>({
        ...options,
        url: '/api/user/score'
    });
};
...
export const getVideo = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetVideoData, ThrowOnError>) => {
